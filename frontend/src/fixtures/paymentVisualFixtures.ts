...
export const VISUAL_QA_GRADUATE_PAYMENT_STATES: Record<string, VisualGraduatePaymentState> = {
  ...
  'grad-liquidated': {
    graduateId: 'grad-liquidated',
    graduateName: 'Carlos Liquidado',
    eventId: 'evt-derecho-2027',
    ...
    installments: [
      { id: 'inst-c1', concept: 'Mensualidad 1', amount: 5000, dueDate: '15 Sep 2026', paidAt: '10 Sep 2026', status: 'PAID' },
      { id: 'inst-c2', concept: 'Mensualidad 2', amount: 5000, dueDate: '15 Oct 2026', paidAt: '10 Oct 2026', status: 'PAID' },
    ],
    confirmedTransactions: [
      { id: 'tx-c1', concept: 'Mensualidad 1', amount: 5000, method: 'TRANSFER', paidAt: '10 Sep 2026', reference: 'SPEI-1111' },
      { id: 'tx-c2', concept: 'Mensualidad 2', amount: 5000, method: 'TRANSFER', paidAt: '10 Oct 2026', reference: 'SPEI-2222' },
    ],
    submissions: [],
  },
  'grad-custom-amount': {
    graduateId: 'grad-custom-amount',
    graduateName: 'Lucía Morales',
    eventId: 'evt-derecho-2027',
    totalContracted: 8250,
    totalPaid: 4125,
    totalPending: 4125,
    totalOverdue: 0,
    ...
    installments: [
      { id: 'inst-l1', concept: 'Mensualidad 1', amount: 1375, dueDate: '15 Dic 2026', paidAt: '15 Dic 2026', status: 'PAID' },
      { id: 'inst-l2', concept: 'Mensualidad 2', amount: 1375, dueDate: '15 Ene 2027', paidAt: '15 Ene 2027', status: 'PAID' },
      { id: 'inst-l3', concept: 'Mensualidad 3', amount: 1375, dueDate: '15 Feb 2027', paidAt: '15 Feb 2027', status: 'PAID' },
      { id: 'inst-l4', concept: 'Mensualidad 4', amount: 1375, dueDate: '15 Mar 2027', status: 'UPCOMING' },
    ],
    confirmedTransactions: [
      { id: 'tx-l1', concept: 'Mensualidad 1', amount: 1375, method: 'TRANSFER', paidAt: '15 Dic 2026', reference: 'SPEI-L1' },
    ],
    submissions: [],
  },
};
