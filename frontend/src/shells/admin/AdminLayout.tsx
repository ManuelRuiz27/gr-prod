...
export const AdminLayout: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-obsidian-950 flex flex-col text-silver-100 selection:bg-gold-500/30 selection:text-silver-50">
      {/* Floating Navigation Drawer (for both Desktop & Mobile views) */}
      <Drawer
        isOpen={isNavOpen}
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <AdminHeader
          ...
          onOpenMobileNav={() => setIsNavOpen(true)}
        />
